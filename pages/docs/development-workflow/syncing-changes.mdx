...
HaTs projects are pre-configured to run your [Testing](/docs/development-workflow/testing/), [Linting](/docs/development-workflow/linting/), and [Style Enforcement](/docs/development-workflow/enforcing-style/) CI Tasks during **each** commit.
