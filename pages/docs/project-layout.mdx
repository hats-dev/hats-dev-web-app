...
Each time you bootstrap a project, the HaTs CLI shallow copies our <a target="_blank" rel="noreferrer" href="https://github.com/hats-dev/hats-scaffold-library">TypeScript template repo on GitHub</a>. Below is the default architecture generated.
