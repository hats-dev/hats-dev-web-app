...
HaTs projects are pre-configured to run your [Testing](/docs/development-workflow/testing), [Linting](/docs/development-workflow/linting), and [Style Enforcement](/docs/development-workflow/enforcing-style) CI Tasks before **each** commit that you execute via `npm run sync`.
