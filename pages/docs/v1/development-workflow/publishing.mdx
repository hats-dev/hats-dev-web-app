...
HaTs projects are pre-configured to run your [Release Preparation](/docs/v1/development-workflow/prepping-releases) CI Tasks before you publish a new major, minor, patch, or pre- release version.
