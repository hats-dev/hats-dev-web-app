...
1. You **must** also update [`paths.main-module-path`](/docs/cli-reference/paths-main-module-path) and [`paths.types-dts-path`](/docs/cli-reference/paths-types-dts-path)
